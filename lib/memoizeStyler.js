(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./utils/cloneStyle", "./utils/styleAssign"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./utils/cloneStyle"), require("./utils/styleAssign"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.cloneStyle, global.styleAssign);
    global.memoizeStyler = mod.exports;
  }
})(this, function (exports, _cloneStyle, _styleAssign) {
  "use strict";
